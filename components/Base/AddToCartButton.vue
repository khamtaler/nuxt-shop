          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <BaseHeader text="Product Added" />
                </DialogTitle>
                <div
                  class="mt-2 flex flex-row items-center justify-center gap-10 px-5"
                >
                ...
                <div class="mt-8 flex items-center justify-between">
                  ...
                  >
                    <span @click="closeModal" class="px-4 py-2">Checkout</span>
                  </NuxtLink>
                </div>
              </DialogPanel>
            </TransitionChild>
...
import { CartButton } from '@/types/components'
...
const props = defineProps<CartButton>()
